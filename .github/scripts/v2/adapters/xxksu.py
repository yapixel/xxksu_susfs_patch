...
PATCH11_FILE_INDEXES: Mapping[str, str] = {
    "kernel/Kconfig": "index 45e09d1..bf7a578 100644",
    ...
    "kernel/supercall/dispatch.c": "index fe628e3..b4c6386 100644",
    "kernel/supercall/supercall.c": "index 59ec582..6e8a1a1 100644",
}
...
PATCH11_PREAMBLE: Tuple[str, ...] = (
    ...
    " kernel/supercall/dispatch.c           |  13 +++",
    " kernel/supercall/supercall.c          |  93 +++++++++++++++",
...
def get_patch11_operation_specs() -> Tuple[XxksuOperationSpec, ...]:
    """Return the 12 self-contained operation specifications matching patch 11 intent."""
    return (
        XxksuOperationSpec(
...
class XxksuAdapter(TargetAdapter):
    ...
    def build_adaptation_plan(self, bundle: SourceBundle) -> FixtureAdaptationPlan:
        """Resolve all 12 anchor locations against clean xxKSU files and construct adaptation plan."""
