...
class BaselineRecordContractTests(unittest.TestCase):
    ...
    def test_xxksu_baseline_record_validates(self) -> None:
        ...
        self.assertEqual(record.status, "VERIFIED")
        self.assertEqual(record.upstream["resolved_commit"], "41c73d28d054f74eabe8a3ba494f14dc3402b3f8")
        self.assertEqual(record.upstream["tree"], "167e2084fa57899826d729d73b7b9a1460cfae89")
        self.assertEqual(record.upstream["archive_sha256"], "7b60584aa794c507d36b87e1a3e473c6732738a15e7e4e4c995827dda973eb75")
