...
def default_registry() -> SemanticRegistry:
    ...
    specs = [
        ...
        s("susfs.supercall.cmd_dispatch", SemanticKind.SUSFS_BEHAVIOR, "supercall", ("kernel/supercall/dispatch.c", "kernel/supercall/supercall.c"), symbols=("susfs_cmd_dispatch", "susfs_auto_reboot", "susfs_start_sdcard_monitor_fn"), source_kinds=("official_10", "xxksu"), confidence=Confidence.HIGH),
        s("susfs.setuid.zygote_handling", SemanticKind.SUSFS_BEHAVIOR, "setuid", ("kernel/hook/setuid_hook.c",), symbols=("handle_zygote_setresuid", "susfs_zygote_sid"), source_kinds=("official_10", "xxksu"), confidence=Confidence.HIGH),
        s("susfs.umount.webview_zygote", SemanticKind.SUSFS_BEHAVIOR, "umount", ("kernel/feature/kernel_umount.c", "kernel/downstream/ksu_hostsredirect.h"), symbols=("ksu_is_webview_zygote_umount_enabled", "susfs_is_current_webview_zygote"), source_kinds=("official_10",), confidence=Confidence.HIGH, notes="official interface; actual xxKSU natively handles webview zygote in kernel_umount"),
        s("susfs.selinux.sid_management", SemanticKind.SUSFS_BEHAVIOR, "selinux", ("kernel/selinux/rules.c", "kernel/selinux/selinux.c", "kernel/selinux/selinux.h"), symbols=("susfs_set_sid", "susfs_get_sid", "susfs_set_priv_app_sid"), source_kinds=("official_10", "xxksu"), confidence=Confidence.HIGH),
        ...
        s("transport.access.definition", SemanticKind.HANDLER_DEFINITION, "access", ("kernel/feature/sucompat.c",), symbols=("ksu_handle_faccessat",), source_kinds=("xxksu",), roles=("definition",), confidence=Confidence.HIGH),
        ...
        s("transport.stat.definition", SemanticKind.HANDLER_DEFINITION, "stat", ("kernel/feature/sucompat.c",), symbols=("ksu_handle_stat",), source_kinds=("xxksu",), roles=("definition",), confidence=Confidence.HIGH),
        ...
        s("transport.fstat_return.linux_call", SemanticKind.LINUX_CALL_SITE, "fstat-return", ("fs/stat.c",), symbols=("ksu_handle_vfs_fstat",), source_kinds=("official_50",), roles=("caller",), confidence=Confidence.HIGH),
        ...
        s("transport.fstat_return.internal_fallback", SemanticKind.SYSCALL_TABLE_HOOK, "fstat-return", ("kernel/hook/syscall_table_hook_arm64.c",), symbols=("ksu_handle_newfstat_ret", "ksu_handle_fstat64_ret"), source_kinds=("xxksu",), roles=("fallback",), confidence=Confidence.HIGH),
        ...
        s("transport.setuid.linux_call", SemanticKind.LINUX_CALL_SITE, "setuid", ("kernel/sys.c",), symbols=("ksu_handle_setresuid",), source_kinds=("official_50",), roles=("caller",), confidence=Confidence.HIGH),
        ...
        s("transport.input.registration", SemanticKind.RUNTIME_REGISTRATION, "input", ("kernel/runtime/ksud.c", "kernel/feature/vol_detector.c"), symbols=("input_register_handler", "vol_detector_event"), source_kinds=("xxksu",), roles=("caller", "definition"), confidence=Confidence.HIGH),
        ...
        s("transport.umount.definition", SemanticKind.HANDLER_DEFINITION, "umount", ("kernel/feature/kernel_umount.c",), symbols=("ksu_handle_umount",), source_kinds=("xxksu",), roles=("definition",), confidence=Confidence.HIGH),
        ...
        s("official50.selinux.avc", SemanticKind.SELINUX_BEHAVIOR, "selinux", ("security/selinux/avc.c",), symbols=("slow_avc_audit",), source_kinds=("official_50",), confidence=Confidence.HIGH),
        s("official50.selinux.setprocattr", SemanticKind.SELINUX_BEHAVIOR, "selinux", ("security/selinux/hooks.c",), symbols=("my_setprocattr",), source_kinds=("official_50",), confidence=Confidence.MEDIUM),
        s("official50.selinux.fake_status", SemanticKind.SELINUX_BEHAVIOR, "selinux", ("security/selinux/selinuxfs.c",), symbols=("ksu_fake_status",), source_kinds=("official_50",), confidence=Confidence.HIGH),
        s("official50.selinux.context_access", SemanticKind.SELINUX_BEHAVIOR, "selinux", ("security/selinux/selinuxfs.c",), symbols=("my_write_context", "my_write_access"), source_kinds=("official_50",), confidence=Confidence.MEDIUM),
        s("official50.selinux.services_wrappers", SemanticKind.SELINUX_BEHAVIOR, "selinux", ("security/selinux/ss/services.c",), symbols=("backup_sepolicy",), source_kinds=("official_50",), confidence=Confidence.HIGH),
