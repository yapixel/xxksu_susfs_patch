...
def default_registry() -> SemanticRegistry:
    ...
    specs = [
        ...
        s("susfs.umount.webview_zygote", SemanticKind.SUSFS_BEHAVIOR, "umount", ("kernel/feature/kernel_umount.c", "kernel/downstream/ksu_hostsredirect.h"), symbols=("ksu_is_webview_zygote_umount_enabled", "susfs_is_current_webview_zygote"), source_kinds=("official_10", "xxksu"), confidence=Confidence.HIGH),
