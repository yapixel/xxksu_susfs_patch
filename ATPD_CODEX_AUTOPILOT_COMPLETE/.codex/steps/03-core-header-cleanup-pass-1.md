# Step 03 Manifest — Core header cleanup pass 1
...
- this manifest: `.codex/steps/03-core-header-cleanup-pass-1.md`
...
```bash
rg -n '_FORTIFY_SOURCE|ATP_VERSION_|EBPF_PROBE_|MODE_EBPF|cfg_' src include tests Makefile 2>/dev/null || true
```
...
- Fortify controlled by build flags
- Compatibility macros removed
- Do not require deleting atp.h yet
...
Write `reports/step-03-report.md` on PASS or `reports/step-03-failed.md` on hard stop.
