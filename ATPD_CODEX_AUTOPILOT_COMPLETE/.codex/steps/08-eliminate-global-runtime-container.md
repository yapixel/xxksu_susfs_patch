# Step 08 Manifest — Eliminate global runtime container
...
- this manifest: `.codex/steps/08-eliminate-global-runtime-container.md`
...
```bash
rg -n 'g_atpd|atpd_global|global_|cfg_' src include tests Makefile 2>/dev/null || true
```
...
Write `reports/step-08-report.md` on PASS or `reports/step-08-failed.md` on hard stop.
